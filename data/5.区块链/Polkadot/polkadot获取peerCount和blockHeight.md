...
`net_peerCount` 目前无法在polkadot主网下获取 peers
count。其是在 [pokadot.js JSON-RPC](https://polkadot.js.org/docs/substrate/rpc) 下 `eth/net` 分组下的，是用来兼容eth的。
...
全网最新节点高度可参看
polkadot的区块浏览器：[https://explorer.polkascan.io/polkadot](https://explorer.polkascan.io/polkadot)
