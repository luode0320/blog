...
```sh
curl --request GET \
     --url 'https://api.moonpay.com/v3/currencies/usdc/sell_quote?quoteCurrencyCode=usd&baseCurrencyAmount=100&apiKey=pk_live_SGCdGCsO4JCl8YaMTMzCaYFLdiedTNS' \
     --header 'accept: application/json'
     
curl --request GET \
     --url 'https://api.moonpay.com/v3/currencies/DOT/sell_quote?quoteCurrencyCode=usd&baseCurrencyAmount=100&apiKey=pk_live_SGCdGCsO4JCl8YaMTMzCaYFLdiedTNS' \
     --header 'accept: application/json'
```
