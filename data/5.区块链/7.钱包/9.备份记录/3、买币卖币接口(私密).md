...
```sh
curl --request GET \
     --url 'https://api.moonpay.com/v3/currencies/usdc/buy_quote?baseCurrencyCode=usd&quoteCurrencyAmount=100&baseCurrencyAmount=200&extraFeePercentage=1&paymentMethod=paypal&areFeesIncluded=true&apiKey=pk_live_SGCdGCsO4JCl8YaMTMzCaYFLdiedTNS' \
     --header 'accept: application/json'
