...
# 测试
curl --request GET \
     --url 'https://api.moonpay.com/v3/currencies/busd/buy_quote?baseCurrencyCode=usd&baseCurrencyAmount=100&apiKey=pk_test_geUKDeYfMUkFjLTjEsxosJiUWcv8TID' \
     --header 'accept: application/json'
     
# 正式
curl --request GET \
     --url 'https://api.moonpay.com/v3/currencies/busd/buy_quote?baseCurrencyCode=usd&baseCurrencyAmount=100&apiKey=pk_live_SGCdGCsO4JCl8YaMTMzCaYFLdiedTNS' \
     --header 'accept: application/json'
```
