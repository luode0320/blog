...
user address: 7C5E6HVYLRDRDRLAVU4SAILMAHDR5UY2V52TGDPDDQHHDFB5VSBCXWOKDI

https://c905541.ellipal.com/admin-vue3#/backend/orderDetail
```

```sh
id=
ede8153f-976b-4c45-800c-079c0c3d28ba
a27250f3-4001-498e-9112-4c30aa002296
你好，这两个订单因为上链时间过长, 被判定为超时, 如果不能兑换请原地址退款。

你好，请帮我查一下订单, 如果不能兑换请原地址退款。
用户原地址: 0xC9D5aE1AE7d2F83032Fc7c50FDdB3D47594b3cFB

https://etherscan.io/tx/0x5632f99756e7996448b18bffe4c96b308b15b0c5957e3722f60fa401d2aa6452
```
...
grep "0.0.9432500" /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log
# hbar账户激活
grep "createHbarAccount" /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log

# 地址转账
grep -r ".*ewtneb5b61f2c7fe47afbc15f64b51e66b0f" /data/wwwroot/wallet/storage/lavarelLog/2025-07-1*/
...
```sh
tail -fn111 /home/deployer/log/golangNodeServer/logs/

tail -fn111 /home/deployer/log/golangNodeServer/logs/app.log 
grep -r ".*7698FBB613666BB6E28D7FCC83A45D0" /home/deployer/log/golangNodeServer/logs/app.log 

tail -fn111 /home/deployer/log/golangNodeServer/logs/RequestDetail/RequestDetail.log 

tail -fn111 /home/deployer/log/golangNodeServer/logs/transfer/transfer.log
tail -fn111  /home/deployer/log/golangNodeServer/logs/app.log | grep -Eri "node makeTx|node sendTx"

# 根据订单查询
grep -r ".*ewtnf8de0080f9ee44ccaef638e7b359cda9" /home/deployer/log/golangNodeServer/logs/transfer/transfer.log


# 查询兑换交易过程
tail -fn111 /home/deployer/log/golangNodeServer/logs/RequestDetail/RequestDetail.log | grep "/adapt/transaction"
tail -fn111 /home/deployer/log/golangNodeServer/logs/app.log | grep "getExchangeOrderStatus"
...
grep ewtn6c56cbecee394ff7ae53518a4e17f7fb /home/deployer/log/finance-go/logs/Transaction/Transaction.log
...
// 在 MongoDB Shell 中执行
db.ESigResult.find({ 
  orderId: /EPLBAC57D5903E24E1692CBC8EF70D6E045/ 
}).pretty()

// 使用文档的 _id 进行删除
db.ESigResult.deleteOne({ 
  _id: ObjectId("684a3aeed51a4a0edfae3e71") 
})
```
