...
user address: 0xCC3b34D2D05fc4C329a0B237a78c63132F6cAaD0

https://etherscan.io/tx/0x8634b067e42e37b9883147fdcaeb49ac3104a360604e191ceb60e3d75613516c
```

```sh
id=d5007d89-30e1-4d1d-b897-bcbf219f698a

你好，请帮我查一下订单, 如果不能兑换请原地址退款。
用户原地址: 0xf4511381fdf3D5cC3F08d8AF4568f24dC5631B4a

0x241226408c7d2df9f6c4f3d127852ef26a1e663ad6037dca4f2fea0e2f6dd486
```

# 安卓

```
\\192.168.2.2\share\jiangping\android4.0_APK\4.8.1
```
...
# php日志目录: 
tail -f -n 11 /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/transaction
tail -f -n 11 /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/transaction | grep "转账 transaction or transactionMax"
tail -f -n 11111 /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/transaction | grep "\"type\":\"send\"" | grep "\"cType\":\"SOL\""
tail -f -n 11 /data/wwwroot/wallet/storage/lavarelLog/2025-06-08/transaction | grep "EPLBA7D04C205FF4C0BAEAE5704940D6EB9"


# 普通日志 
tail -f -n 11 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log | grep "交易重构"
tail -f -n 11 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log | grep "添加币种"
tail -f -n 11 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log | grep "xrp账号trustSetandpaymentAsset="
tail -f -n 11 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log | grep "getBalanceV4="
tail -f -n 11 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log | grep "getBalancelistV4="
tail -f -n 11 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log | grep -E  "添加jpush关联数据，入参=|addJId"
grep -r "转账 transaction or transactionMax =.*GD6DSEIX6DW2MZM4TYV4TKJOD6S3TUWOI4RVRTATKVBMA6KLQWNH6BSE" /data/wwwroot/wallet/storage/logs/

# 普通日志
grep "14akoDb8RwoEAGZH9Fd99wzwSp6x3nZRGJeWqWWPucwKWmhG" /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log

  
# hbar账户激活
grep "createHbarAccount" /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log

# 转账 
grep -r ".*HC32ZAUGFBXKAXUK7DLDOF33XE72Q5ESH5AFI4GLIFIF7R7CBKUG6RNUH4" /data/wwwroot/wallet/storage/lavarelLog/2025-08-11/
grep -r ".*ewtne4fb9af788a748a6a3a8d5f502ea3925" /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/transaction

# getBalance余额
grep -r ".*getBalanceV4=" /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log
tail -f -n 11 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log | grep "getBalanceV4="

grep -r ".*getBalanceV4=" /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log


tail -f -n 11 /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/xrpaccountsetinfo
tail -f -n 11 /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/xrpaccountsetinfoUrl

# php转账 
tail -f -n 1111 /data/wwwroot/wallet/storage/logs/laravel-$(date '+%Y-%m-%d').log  | grep -E "转账统一|转账 transaction or transactionMax|addressDIDinfo--|Check amount|Check httpType|Check cType|dddddd|params|this tokenRecord|rb amount gwei| 未获取到txid|提币|存币"
...
grep -r --include='laravel-2025-05-27.log' \
  "转账 transaction or transactionMax =.*cosmos1c9jgm5n6mud64ta7j0ak8y92wt87kgcuhxzgnc" \
  /data/wwwroot/wallet/storage/logs/
grep -r --include='laravel-2025-05-27.log' \
  "转账统一接口,参数=.*cosmos1c9jgm5n6mud64ta7j0ak8y92wt87kgcuhxzgnc" \
  "转账 transaction or transactionMax =.*cosmos1c9jgm5n6mud64ta7j0ak8y92wt87kgcuhxzgnc" \
  /data/wwwroot/wallet/storage/logs/
grep -r --include='laravel-2025-06-08.log' \
  "2025-06-08 05:55:35.*转账统一接口,参数=.*EPLBA7D04C205FF4C0BAEAE5704940D6EB9" \
  /data/wwwroot/wallet/storage/logs/
grep -r --include='laravel-2025-06-08.log' \
  "2025-06-08 05:55:35.*" \
  /data/wwwroot/wallet/storage/logs/
  
tail -f -n 11111111 /data/wwwroot/wallet/storage/lavarelLog/2025-06-08/transaction | grep -E "2025-06-08 05|2025-06-08 06:0" | grep "EPLBA7D04C205FF4C0BAEAE5704940D6EB9"


# 余额
grep -rinI bc1qhljwtjwv48z0a5hfulwl6x5k8nkak6v4u8gvft /data/wwwroot/wallet/storage/logs/laravel-2025-04-1*

# xrp
tail -fn111 /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/xrpaccountsetinfo


# algo
tail -fn111 /data/wwwroot/wallet/storage/lavarelLog/$(date '+%Y-%m-%d')/algoaccountsetinfo
...
# sol节点
journalctl --user -u solcoin -f
```

# go-api

```sh
tail -fn11 /home/deployer/log/golangNodeServer/logs/

# 普通
tail -fn11 /home/deployer/log/golangNodeServer/logs/app.log 
grep -r ".*7698FBB613666BB6E28D7FCC83A45D0" /home/deployer/log/golangNodeServer/logs/app.log 
tail -fn11  /home/deployer/log/golangNodeServer/logs/app.log | grep -Eri "node makeTx|node sendTx"

# 转账
tail -fn11 /home/deployer/log/golangNodeServer/logs/transfer/transfer.log
grep -r ".*HC32ZAUGFBXKAXUK7DLDOF33XE72Q5ESH5AFI4GLIFIF7R7CBKUG6RNUH4" /home/deployer/log/golangNodeServer/logs/transfer/transfer.log
tail -fn11 /home/deployer/log/golangNodeServer/logs/transfer/transfer.log | grep -Eri "HC32ZAUGFBXKAXUK7DLDOF33XE72Q5ESH5AFI4GLIFIF7R7CBKUG6RNUH4" 

# 请求
tail -fn11 /home/deployer/log/golangNodeServer/RequestDetail/RequestDetail.log 
grep -r ".*1111" /home/deployer/log/golangNodeServer/RequestDetail/RequestDetail.log 
tail -fn11  /home/deployer/log/golangNodeServer/RequestDetail/RequestDetail.log | grep -Eri "node makeTx|node sendTx"


# 查询兑换交易过程
tail -fn11 /home/deployer/log/golangNodeServer/logs/RequestDetail/RequestDetail.log | grep "/adapt/transaction"
tail -fn11 /home/deployer/log/golangNodeServer/logs/app.log | grep "getExchangeOrderStatus"
...
# 自启配置目录
~/.config/systemd/user
cat ~/.config/systemd/user/financeGo.service
# 通用 0x0C43dF7387d3eB673d7DfEf531aF89181e539Ccd


tail -f -n 111 /home/deployer/log/finance-go/logs/app.log
grep -r ".*ewtn292b2252707e4ca3833739e1c0fe1882" /home/deployer/log/finance-go/logs/app.log 
grep -r ".*FzXhVtsHLCvWk2LaQgarriHNUMshwZz2pyL5KhBUBuZF" /home/deployer/log/finance-go/logs/app.log 
...
grep 3Efo9aCDmju1PbJ6rZbes61swiuXPzaXj5 /home/deployer/log/finance-go/logs/requestdetail/requestdetail.log
grep 0x08Af86F7b264d49F37bd2752dD77FC1aae04e7BE /home/deployer/log/finance-go/logs/Requestdetail/Requestdetail.log

# 转账日志
tail -f -n 111 /home/deployer/log/finance-go/logs/transaction/transaction.log
grep TSTkWSNF2cUVAarFrEN9Lft1KEXMmdoD1u /home/deployer/log/finance-go/logs/transaction/transaction.log

# 订单状态日志
tail -f -n 111 /home/deployer/log/finance-go/logs/orderstate/orderstate.log
grep ewtn6c56cbecee394ff7ae53518a4e17f7fb /home/deployer/log/finance-go/logs/orderstate/orderstate.log

# 根据地址查询
grep -r ".*rnM7pNxm2mpEky891CrGc3waDJFqzryFkK" /home/deployer/log/finance-go/logs/
grep -r ".*AAPLX(SOL)" /home/deployer/log/finance-go/logs/

# 获取范围汇率 没有币种价格 
grep -r "获取范围" /home/deployer/log/finance-go/logs/app.log
...
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "列表"
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "创建预订单: "
 
# 创建订单 
grep -r "创建订单完成:BTC.*bc1qc8kvzhk005"  /home/deployer/log/finance-go/logs/app-2025-07-17*
grep -r "创建订单错误:.*0x9342cfe2315fe3594444864c19f8deEf34Fd3A62"  /home/deployer/log/finance-go/logs/app-2025-07-1*

tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "CreateOrder"
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "创建订单" 
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "创建订单完成" 
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "订单保存" 
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "实时推送" 
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "兑换推送" 
tail -f -n 1111 /home/deployer/log/finance-go/logs/app.log | grep "获取范围:ETH(ARB)_BTC(BTC) 交易所"
tail -f -n 1111 /home/deployer/log/finance-go/logs/app.log | grep "预订单"
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "创建订单异常" 


tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "调整下架币对" 

# 订单追踪更改状态 
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "订单状态" 
...
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "超时追踪订单状态" 
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "超时追踪订单状态异常" 
#
 
tail -f -n 111 /home/deployer/log/finance-go/logs/app.log | grep "请求响应错误" 
#
mv -f /home/deployer/log/finance-go/logs/dump/priceMap.json /tmp/luode/
mv -f /home/deployer/log/finance-go/logs/dump/TokenInfos.json /tmp/luode/
```
...
# push
tail -f -n 111 "/home/deployer/log/admin-go/logs/$(date '+%Y-%m-%d').log" | grep "推送"

# 统计对冲转账记录结束
tail -f -n 111 "/home/deployer/log/admin-go/logs/$(date '+%Y-%m-%d').log" | grep "统计对冲转账记录结束"

ps -ef | grep goadmin
journalctl --user-unit goadmin.service -f
```
...
# 解压日志
gunzip /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-06-05.0.gz
tail -f -n 111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-06-08.2 | grep "\-\-\-\-\-\-"
grep -r '转账发送签名请求req' /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-09-02*

# 通用  获取收费策略 获取钱包余额  获取钱包余额
tail -f -n 11 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log
tail -f -n 111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-06-04.2
...
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "获取钱包余额"
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "获取收费策略"
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "创建交易"
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "获取Gas费"
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "执行转账"
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "兑入买现货"
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "转账发送签名请求req"

grep -r '0xe61f1Ba28D5D8f5a2B39C14d3e98E2c527c0Aff4' /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-08-27*


# req/send
tail -f -n 111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "http response status = "
...
tail -f -n 111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-06-05.0 | grep --color=always -E "对冲初始化: 充币到交易所|充币到交易所, 状态:.*false|充币到交易所, 状态:|充币开始"

# 对冲提币
tail -f -n 111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep -E "对冲初始化: 提币到币池|提币到币池完成"
tail -f -n 111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-006-05.0 | grep -E "对冲初始化: 提币到币池|提币到币池完成"
...
tail -f -n 111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "划转"
...
# 链上确认开始 提币: 
tail -f -n 111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "链上确认"
tail -f -n 111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-06-05.0 | grep "链上确认"
tail -f -n 111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5076.log.2025-06-04.3 | grep "链上确认"
# 提币:
tail -f -n 111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5076.log | grep "提币:"
```
...
db.transaction_log.find({
  type: 'req',
  time: { $gte: ISODate('2025-07-28T00:00:00.000Z') }
}).sort({ time: 1 })
...
fs.writeFileSync('/tmp/luode/req2025-05-01.json', "{}", null, 2))
...
# 只返回ip的数据, { ip: '174.236.225.224' }
db.transaction_log.aggregate([
  {
    $match: {
      type: 'req',
      time: { $gte: ISODate('2025-07-28T00:10:00.000Z') }
    }
  },
  {
    $project: {
      _id: 0, // 不返回原始ID
      ip: '$httpBody.ip' // 提取httpBody.ip字段并重命名为ip
    }
  },
  {
    $sort: { time: 1 } // 按时间升序排列
...
# 返回去重后的 IP 地址列表，并以逗号拼接成字符串
db.transaction_log.aggregate([
  {
    $match: {
      type: 'req',
      time: { $gte: ISODate('2025-07-01T00:00:00.000Z') }
    }
  },
  {
    $group: {
      _id: '$httpBody.ip' // 按IP分组去重
    }
  },
  {
    $group: {
      _id: null,
      ips: { $push: '$_id' } // 收集所有唯一IP到数组
    }
  },
  {
    $project: {
...
db.transaction_log.aggregate([
  {
    $match: {
      "httpBody.ip": { $exists: true, $ne: null, $ne: "" } // 仅保留有效IP
    }
  },
  {
    $group: {
...
​```
// 获取日期范围
let startDate = new Date("2025-01-01"); // 设置开始日期
let endDate = new Date(); // 设置结束日期（今天）
...
while(currentDate <= endDate) {
    ...
    // 构建当天的聚合查询
    let dailyIps = db.transaction_log.aggregate([
        {
            $match: {
                // "httpBody.orderID": {
                //     $exists: true,
    ...
    // 将当天的IP添加到总集合中
    dailyIps.forEach(doc => allIps.add(doc.ip));
    
    // 移动到下一天
    currentDate = nextDate;
    
    // 打印进度
    print(`已处理 ${currentDate.toISOString().split('T')[0]}，当前累计IP数: ${allIps.size}`);
}


// 最终处理：将Set转换为数组并拼接成字符串
let uniqueIps = Array.from(allIps);
let totalCount = uniqueIps.length;
let ipString = uniqueIps.join(','); // 用逗号拼接所有IP

print(`总共收集到 ${totalCount} 个唯一IP地址`);
print(`所有IP地址: ${ipString}`);
​```
2025-01~2025-07
所有转账: 71887个ip 1338 ip中国  2%
仅兑换: 17427个ip 367 ip中国  2%
用ellipal钱包转过账的ip中, 24%的ip使用过兑换
```
...
// 在 MongoDB Shell 中执行
db.ESigResult.find({ 
  orderId: /EPL3DE39E33508E44AF9D3BF91202E2C445/ 
}).pretty()

// 使用文档的 _id 进行删除
db.ESigResult.deleteOne({ 
  _id: ObjectId("68b61cf268d5831ad0190753") 
})
```
...
redis-cli -p 6379 GET "EllipalNodeSync:ContractList" > ContractList.txt | jq # 币对数据
...
mkdir -p  /tmp/luode && redis-cli -p 6379 GET "EllipalNodeSync:ContractList" > /tmp/luode/ContractList.txt  
mkdir -p  /tmp/luode && redis-cli -p 6379 GET "token_prices_redis_key"  > /tmp/luode/prices.txt 
redis-cli -p 6379 GET "CoinsAllowOrderCYnewChangenowOnly" # 获取swif兑换支持的币种 单向支持 
redis-cli -p 6379 GET "pricerate" # 获取法币汇率 satebyteEvalFeesFivedays: webVersion
redis-cli -p 6379 GET "webVersion" # 获取web版本
...
redis-cli -p 6379 GET "satebyteEvalFeesFivedays:BTC" # 获取BTC GAS price  "4.822916245" "4.56591073"
redis-cli -p 6379 SET "satebyteEvalFeesFivedays:BTC" "7.23046875"
redis-cli -p 6379 GET "gasHBAR" # 967004
redis-cli -p 6379 SET "gasHBAR" "4835020"

redis-cli -p 6379 --scan --pattern "XRP-trustLines:*" | head -10 | xargs -I {} redis-cli -p 6379 GET {}  # 查询10条某前缀的key

docker exec -it redis redis-cli -p 6379 GET "token_prices_redis_key"  > /tmp/luode/prices.txt 
```
...
# 定时检查abd服务
# 编辑当前用户的 crontab
(crontab -l 2>/dev/null; echo "* * * * * /usr/bin/adb devices >/dev/null 2>&1") | crontab -
# 查看是否包含 adb 任务
crontab -l | grep adb  

# 开启自启
sudo vim /etc/systemd/system/hedgeswapSignManager.service
​```
[Unit]
Description=HedgeSwap Sign Manager Service
After=network.target

[Service]
Type=simple
User=root
WorkingDirectory=/root/luode/hedgeswapSignManager
ExecStart=/root/luode/hedgeswapSignManager/main -f /root/luode/hedgeswapSignManager/config.yml
Restart=always
RestartSec=30
StandardOutput=syslog
StandardError=syslog
SyslogIdentifier=hedgeswapSignManager

[Install]
WantedBy=multi-user.target
​```
systemctl daemon-reload
systemctl start hedgeswapSignManager
systemctl enable hedgeswapSignManager
systemctl status hedgeswapSignManager
# 查看日志
journalctl -u hedgeswapSignManager -f -n 111
```
...
SELECT * FROM assett where ctime >= 1745769600

# 查询地址在哪个设备
SELECT * FROM jpush
where id = 'bc1qhljwtjwv48z0a5hfulwl6x5k8nkak6v4u8gvft'

SELECT * FROM jpush order BY id desc limit 11
```
...
SELECT 
    SUBSTRING_INDEX(pair, '_', -1) AS coin_name,
    FLOOR(SUM(rprice * volumeLast)) AS total_usd,  -- 使用 FLOOR 去除小数
    DATE_FORMAT(STR_TO_DATE('2025-06', '%Y-%m'), '%Y-%m') AS time
FROM `ellpal`.`orderUser`
WHERE `pair` LIKE '%_%'  -- 确保有一个 `_` 分隔符
  AND `status` = '4'
  AND ctime >= UNIX_TIMESTAMP(DATE_FORMAT(STR_TO_DATE('2025-06', '%Y-%m'), '%Y-%m-01'))  -- 动态开始时间
  AND ctime < UNIX_TIMESTAMP(DATE_FORMAT(STR_TO_DATE('2025-06', '%Y-%m'), '%Y-%m-01') + INTERVAL 1 MONTH)  -- 动态结束时间
  AND SUBSTRING_INDEX(pair, '_', -1) NOT LIKE '%USDT%'  -- 排除 coin_name 包含 'USDT'
GROUP BY coin_name
ORDER BY total_usd DESC;
...
```sh
vi /var/spool/cron/www
crontab -e

# 更新gas
python /data/wwwroot/wallet/storage/monitor/calFeeValue.py
...
# 用户资产: admin_account_status_details -> v_admin_account -> admin_currency_status_details 
# v_admin_account_week_details v_admin_account_month_details v_admin_account_year_details
python /data/wwwroot/wallet/storage/h5admin_data/account_all.py
python /data/wwwroot/wallet/storage/h5admin_data/currency_diff_all.py
python /data/wwwroot/wallet/storage/h5admin_data/account_all_date.py # 统计
python /data/wwwroot/wallet/storage/h5admin_data/currency_all_price.py # 重新统计价值
python /data/wwwroot/wallet/storage/h5admin_data/update_coin_price.py

python /data/wwwroot/wallet/storage/h5admin_data/update_coin_price.py

python /data/wwwroot/wallet/storage/h5admin_data/currency_all.py
python /data/wwwroot/wallet/storage/h5admin_data/currency_detail.py
python /data/wwwroot/wallet/storage/h5admin_data/account_all.py 


python /data/wwwroot/wallet/storage/h5admin_data/coin_currency_price.py  # 
python /data/wwwroot/wallet/storage/h5admin_data/currency_all_history.py 
python /data/wwwroot/wallet/storage/h5admin_data/currency_all_price.py
python /data/wwwroot/wallet/storage/h5admin_data/currency_all.py
python /data/wwwroot/wallet/storage/h5admin_data/currency_csv.py
python /data/wwwroot/wallet/storage/h5admin_data/error_coin_currency_all.py
python /data/wwwroot/wallet/storage/h5admin_data/account_all_test.py
python /data/wwwroot/wallet/storage/h5admin_data/update_account_coin_price.py

* * * * * python /data/wwwroot/wallet/storage/monitor/controlEllipalController.py


# 统计redis里所有key的内存占用, 有个文件redis-top100.txt
/home/www/python/php-redis-memory.py
```
...
SELECT *
FROM coins
WHERE logo LIKE '%ellipal.com/%';

-- 查询coins表
SELECT *
FROM coins
WHERE logo LIKE '%images.ellipal.com%';

-- 确认无误后执行更新
-- 确认无误后执行更新
UPDATE coins
SET logo = CONCAT('https://images.ellipal.com', SUBSTRING(logo, LENGTH(REGEXP_SUBSTR(logo, 'https://wallettest.ellipal.com/images|https://wallet.ellipal.com/images')) + 1))
WHERE id = 3
  AND (logo LIKE 'https://wallettest.ellipal.com/images%' OR logo LIKE 'https://wallet.ellipal.com/images%');
...
-- 确认无误后执行更新
UPDATE coinsAda
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';
...
-- 查询coins表
SELECT *
FROM ellpal_dev.coins
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coins
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsAda 表
SELECT *
FROM ellpal_dev.coinsAda
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsAda
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsbsc 表
SELECT *
FROM ellpal_dev.coinsbsc
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsbsc
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsDefault 表
SELECT *
FROM ellpal_dev.coinsDefault
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsDefault
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsEos 表
SELECT *
FROM ellpal_dev.coinsEos
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsEos
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsflr 表
SELECT *
FROM ellpal_dev.coinsflr
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsflr
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsftm 表
SELECT *
FROM ellpal_dev.coinsftm
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsftm
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsheco 表
SELECT *
FROM ellpal_dev.coinsheco
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsheco
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsmatic 表
SELECT *
FROM ellpal_dev.coinsmatic
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsmatic
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsNew 表
SELECT *
FROM ellpal_dev.coinsNew
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsNew
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';

-- 查询 coinsxdc 表
SELECT *
FROM ellpal_dev.coinsxdc
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%';

-- 确认无误后执行更新
UPDATE ellpal_dev.coinsxdc
SET logo = REPLACE(logo, '.svg', '.png')
WHERE logo LIKE 'https://wallettest.ellipal.com/images/coins/%.svg';
```
...
(SELECT 'coins' AS table_name, cType, shortName, contractAddr, logo FROM coins WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsAda' AS table_name, cType, shortName, contractAddr, logo FROM coinsAda WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsbsc' AS table_name, cType, shortName, contractAddr, logo FROM coinsbsc WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsDefault' AS table_name, cType, shortName, contractAddr, logo FROM coinsDefault WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsEos' AS table_name, cType, shortName, contractAddr, logo FROM coinsEos WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsflr' AS table_name, cType, shortName, contractAddr, logo FROM coinsflr WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsftm' AS table_name, cType, shortName, contractAddr, logo FROM coinsftm WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsheco' AS table_name, cType, shortName, contractAddr, logo FROM coinsheco WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsmatic' AS table_name, cType, shortName, contractAddr, logo FROM coinsmatic WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsNew' AS table_name, cType, shortName, contractAddr, logo FROM coinsNew WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%')
UNION ALL
(SELECT 'coinsxdc' AS table_name, cType, shortName, contractAddr, logo FROM coinsxdc WHERE logo LIKE '%wallet.ellipal.com/%' or logo LIKE '%wallettest.ellipal.com/%');    
...
-- 确认无误后执行更新
UPDATE coins
SET logo = CONCAT('https://images.ellipal.com/','','smart.','.png')
WHERE logo = CONCAT('https://wallettest.ellipal.com/','images/','smart','.png')
	  or logo = CONCAT('http://wallettest.ellipal.com/','images/','smart','.png')
or logo = CONCAT('https://wallet.ellipal.com/','images/','smart','.png')
or logo = CONCAT('http://wallet.ellipal.com/','images/','smart','.png')

-- 确认无误后执行更新
UPDATE coins
SET logo = CONCAT('https://images.ellipal.com/','coins/','eca','.png')
WHERE logo = CONCAT('https://wallettest.ellipal.com/','images/coins','eca','.png')
	  or logo = CONCAT('http://wallettest.ellipal.com/','images/coins','eca','.png')
or logo = CONCAT('https://wallet.ellipal.com/','images/coins','eca','.png')
or logo = CONCAT('http://wallet.ellipal.com/','images/coins','eca','.png')

-- 确认无误后执行更新
UPDATE coinsAda
SET logo = 'https://images.ellipal.com/coins/BSC.png'
WHERE logo = 'https://wallettest.ellipal.com/images/coins/BSC.png'
...
```sql
-- 定义变量
SET @old_logo1 = 'https://wallet.ellipal.com/images/btc.png';
SET @old_logo2 = 'https://wallettest.ellipal.com/images/btc.png';
SET @new_logo = 'https://images.ellipal.com/btc.png';

-- 更新coins表
UPDATE coins
SET logo = @new_logo
WHERE logo = @old_logo1 OR logo = @old_logo2;
...
```sql
CREATE TABLE `desc_translation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `keywords` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'key(唯一, 使用key查询, 可读性高于code)',
  `code` int NOT NULL DEFAULT '500' COMMENT 'code(默认500)',
  `zhcn` varchar(200) NOT NULL DEFAULT '' COMMENT '中文(简体),覆盖中国大陆、新加坡、马来西亚（约 17.5%）',
  `enus` varchar(200) NOT NULL DEFAULT '' COMMENT '英语(国际),全球通用语言（约 13.4%）',
  `hi` varchar(200) NOT NULL DEFAULT '' COMMENT '印地语,印度及南亚地区（约 7.5%）',
  `es` varchar(200) NOT NULL DEFAULT '' COMMENT '西班牙语,西班牙、拉丁美洲（约 6.0%）',
  `ar` varchar(200) NOT NULL DEFAULT '' COMMENT '阿拉伯语,中东、北非（约 5.3%）',
  `pt` varchar(200) NOT NULL DEFAULT '' COMMENT '葡萄牙语,巴西、葡萄牙（约 3.6%）',
  `bn` varchar(200) NOT NULL DEFAULT '' COMMENT '孟加拉语,孟加拉国、印度部分地区（约 3.3%）',
  `ru` varchar(200) NOT NULL DEFAULT '' COMMENT '俄语,俄罗斯、东欧（约 2.8%）',
  `ja` varchar(200) NOT NULL DEFAULT '' COMMENT '日语,日本（约 1.6%）',
  `de` varchar(200) NOT NULL DEFAULT '' COMMENT '德语,德国、奥地利、瑞士（约 1.5%）',
  `fr` varchar(200) NOT NULL DEFAULT '' COMMENT '法语,法国、加拿大、非洲（约 1.4%）',
  `ms` varchar(200) NOT NULL DEFAULT '' COMMENT '马来语,马来西亚、印尼（约 1.3%）',
  `vi` varchar(200) NOT NULL DEFAULT '' COMMENT '越南语,越南（约 1.2%）',
  `zhhk` varchar(200) NOT NULL DEFAULT '' COMMENT '中文(繁体),覆盖中国台湾地区、中国香港地区、中国澳门地区（约 1.0%）',
  `tr` varchar(200) NOT NULL DEFAULT '' COMMENT '土耳其语,土耳其及中亚部分地区（约 1.0%）',
  `it` varchar(200) NOT NULL DEFAULT '' COMMENT '意大利语,意大利、瑞士部分地区（约 0.9%）',
  `ko` varchar(200) NOT NULL DEFAULT '' COMMENT '韩语,韩国及朝鲜（约 0.9%）',
  `th` varchar(200) NOT NULL DEFAULT '' COMMENT '泰语,泰国及东南亚部分地区（约 0.9%）',
  `pl` varchar(200) NOT NULL DEFAULT '' COMMENT '波兰语,波兰（约 0.5%）',
  `nl` varchar(200) NOT NULL DEFAULT '' COMMENT '荷兰语,荷兰、比利时及加勒比地区（约 0.3%）',
  `status` tinyint DEFAULT '1' COMMENT '状态: 1=启用 不等于1=停用',
  `createTime` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updateTime` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `idex_key` (`keywords`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='文档翻译表(总覆盖比例达到全球人口约 85%)';


我现在需要新增一条数据, code=500,zhcn="异常, 请稍后重试!"
帮我补充剩余的语言翻译, 并给出一条新增sql
```

# xrp

```
xrp的保留金会随着添加的代币越多, 需要的保留金越多。每多一个代币需要多增加0.2xrp
xrp本身要保留1个xrp
```
...
```
eth 0x6a5374c6023d7520d51244B337b41E2C3683d2ab
```
...
```
1. exchange_strategy_layout表配置交易所
2. exchange_routing_strategy表配置优先级, 最大交易额
3. exchange_strategy_config表配置收费策略
```
