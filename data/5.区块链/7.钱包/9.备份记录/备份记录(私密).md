...
```sh
id=a86684a8-51bf-470c-9fea-f550a0252efb

你好，请帮我查一下订单, 如果不能兑换请原地址退款。
用户原地址: 0x58779506cBE2A1fAbBBB07AA62B6263675A07145


https://etherscan.io/tx/0x1086f157522ae45ee6c89070f415e7b3b160294555aed9430d0f13ea4a768854
```
...
# 创建订单
tail -f -n 11111 /var/log/finance-go/logs/app.log | grep "创建订单"
