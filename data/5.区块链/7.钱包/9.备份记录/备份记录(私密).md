...
# 获取范围汇率 没有币种价格
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "获取范围"
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "获取汇率"
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep -E "获取范围|获取汇率"

# 创建订单
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "CreateOrder"

# 订单追踪更改状态
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "追踪订单状态" 
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "追踪订单状态: 已完成"
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "获取交易对价格"
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "获取交易对价格异常"
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "当前币价priceMap总数量"
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "追踪超时订单状态" 
tail -f -n 11111 /home/deployer/log/finance-go/logs/app.log | grep "追踪超时订单状态异常" 
```
...
tail -f -n 11 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log	(http)
...
tail -f -n 11111 /home/deployer/spug/repos/java/logs/crypto-strategy-5005.log | grep "保存orderUser订单到MySQL"
```
...
# 解压日志
gunzip /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-03-24.0.gz
tail -f -n 11111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-03-24.0 | grep "\-\-\-\-\-\-"

# 通用  获取收费策略 获取钱包余额
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log
tail -f -n 11111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-02-07.1
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "\-\-\-\-\-\-"
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep -E "\-\-\-\-\-\-|\*\*\*\*\*\*" 
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "\*\*\*\*\*\*"
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "兑入数量" 
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "获取币种的美元价格"
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "获取收费策略"

# 创建订单成功
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "状态: WAITING_PAYMENT"

# ws连接: 接收到的文本消息 转账ws接收交易签名失败 
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "ws"
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "ws连接: 接收到的文本消息"
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "转账ws接收交易签名"
tail -f -n 11111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "处理签名事件"

# 轮询转账状态
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "轮询转账状态开始"
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "获取钱包余额"

# 兑换对冲买现货开空单
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "对冲兑"

# 链上确认
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "链上确认"
# 链上确认成功
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "链上确认成功"
# 链上确认失败
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "链上确认失败"

# 兑换: 
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep --color=always "兑换结束:.*false\|兑换结束:"
# 兑换完成
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "兑换结束: 状态: true"
# 兑换错误
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "兑换结束: 状态: false"


# 对冲入口 
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep -E "对冲第一步|对冲初始化"
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-03-24.0 | grep -E "对冲第一步|对冲初始化"

# 对冲充币
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep --color=always -E "对冲初始化: 充币到交易所|充币到交易所, 状态:.*false|充币到交易所, 状态:|充币开始"
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-03-24.0 | grep --color=always -E "对冲初始化: 充币到交易所|充币到交易所, 状态:.*false|充币到交易所, 状态:|充币开始"

# 对冲提币
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep -E "对冲初始化: 提币到币池|提币到币池完成"
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-03-24.0 | grep -E "对冲初始化: 提币到币池|提币到币池完成"

# 对冲交易所到账, 卖现货平合约
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep -E "对冲初始化: 充币到交易所|交易所确认到账成功|对冲结束"
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-03-24.0 | grep -E "对冲初始化: 充币到交易所|交易所确认到账成功|对冲结束"

# 划转
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/archive/exchange-ellipal-5075.log.2025-03-24.0 | grep "划转"

# 对冲结束
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "对冲结束"

# 链上确认开始
tail -f -n 11111111 /home/deployer/spug/repos/java/logs/exchange-ellipal-5075.log | grep "链上确认开始"
```
...
# kafka消息监听器: 处理法币交易订单
tail -f -n 1111111 /home/deployer/spug/repos/java/logs/crypto-strategy-5005.log | grep "kafka消息监听器"
tail -f -n 1111111 /home/deployer/spug/repos/java/logs/crypto-strategy-5005.log | grep "kafka消息监听器: 处理法币交易订单"
tail -f -n 1111111 /home/deployer/spug/repos/java/logs/crypto-strategy-5005.log | grep "kafka消息监听器: 处理法币交易订单, 更新到mysql数据库"
tail -f -n 1111111 /home/deployer/spug/repos/java/logs/crypto-strategy-5005.log | grep "kafka消息监听器: 处理法币交易订单, orderId: bstn36f32439256c4795a927f1971b624fd3"

tail -f -n 1111111 /home/deployer/spug/repos/java/logs/crypto-strategy-5005.log | grep "创建买币卖币订单"
```
...
# 抓包ip
tcpdump -i any "host 119.8.185.250" -A -n
```
...
# BTC
elp://1:1@sync2/EC02+_V4.3.0/3146B9B4BA527A436BBFA9F0C993B4E2B868CED5/兑换模拟数据/BTC[1PN3t69veBjogJwMNgPt3fC9khutRwwJiv[CF848C741D1989C0F779851B9ECBD6FDF9084D1382ED4DA19163185DFC4FE46F/17xNxkEwUDEPBUFT83z4RqpWRi5wL8zfuL
