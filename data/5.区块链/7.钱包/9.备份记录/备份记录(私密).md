...
SET price = '95209.14'
WHERE (fiat = 'BTC' OR currency = 'BTC');
UPDATE mercuryobusiness   
SET price = '2663.11'
WHERE (fiat = 'ETH' OR currency = 'ETH');
UPDATE mercuryobusiness   
SET price = '2.55'
WHERE (fiat = 'XRP' OR currency = 'XRP');
UPDATE mercuryobusiness   
SET price = '164.66'
WHERE (fiat = 'SOL' OR currency = 'SOL');
UPDATE mercuryobusiness   
SET price = '644.79'
WHERE (fiat = 'BNB' OR currency = 'BNB');
UPDATE mercuryobusiness   
SET price = '0.24919'
WHERE (fiat = 'DOGE' OR currency = 'DOGE');
UPDATE mercuryobusiness   
SET price = '0.32242'
WHERE (fiat = 'XLM' OR currency = 'XLM');
UPDATE mercuryobusiness   
SET price = '0.23929'
WHERE (fiat = 'TRX' OR currency = 'TRX');
UPDATE mercuryobusiness   
SET price = '3.03421'
WHERE (fiat = 'SUI' OR currency = 'SUI');
UPDATE mercuryobusiness   
SET price = '0.77095'
WHERE (fiat = 'ADA' OR currency = 'ADA');
UPDATE mercuryobusiness   
SET price = '17.9155'
WHERE (fiat = 'LINK' OR currency = 'LINK');
UPDATE mercuryobusiness   
SET price = '4.5638'
WHERE (fiat = 'ATOM' OR currency = 'ATOM');
UPDATE mercuryobusiness   
SET price = '4.6866'
WHERE (fiat = 'DOT' OR currency = 'DOT');
UPDATE mercuryobusiness   
SET price = '123.0546'
WHERE (fiat = 'LTC' OR currency = 'LTC');
UPDATE mercuryobusiness   
SET price = '1'
WHERE (fiat = 'USDC' OR currency = 'USDC');
UPDATE mercuryobusiness   
SET price = '312.822'
WHERE (fiat = 'BCH' OR currency = 'BCH');
UPDATE mercuryobusiness   
SET price = '0.9997'
WHERE (fiat = 'RLUSD' OR currency = 'RLUSD');
UPDATE mercuryobusiness   
SET price = '0.0009802'
WHERE (fiat = 'ARB' OR currency = 'ARB');
UPDATE mercuryobusiness   
SET price = '95209.14'
WHERE (fiat = 'WBTC' OR currency = 'WBTC');
UPDATE mercuryobusiness   
SET price = '254.407'
WHERE (fiat = 'AAVE' OR currency = 'AAVE');
UPDATE mercuryobusiness   
SET price = '254.407'
WHERE (fiat = 'AAVE' OR currency = 'AAVE');
UPDATE mercuryobusiness   
SET price = '0.01602'
WHERE (fiat = 'XYO' OR currency = 'XYO');
UPDATE mercuryobusiness   
SET price = '3.65298'
WHERE (fiat = 'TON' OR currency = 'TON');
UPDATE mercuryobusiness   
SET price = '4.2364'
WHERE (fiat = 'AXS' OR currency = 'AXS');
UPDATE mercuryobusiness   
SET price = '1'
WHERE (fiat = 'TUSD' OR currency = 'TUSD');
UPDATE mercuryobusiness   
SET price = '0.007979'
WHERE (fiat = 'DGB' OR currency = 'DGB');
UPDATE mercuryobusiness   
SET price = '0.85804'
WHERE (fiat = 'XTZ' OR currency = 'XTZ');
UPDATE mercuryobusiness   
SET price = '4.2364'
WHERE (fiat = 'AXS-ERC20' OR currency = 'AXS-ERC20');
UPDATE mercuryobusiness   
SET price = '1'
WHERE (fiat = 'BUSD' OR currency = 'BUSD');
UPDATE mercuryobusiness   
SET price = '1.00005'
WHERE (fiat = 'DAI' OR currency = 'DAI');
UPDATE mercuryobusiness   
SET price = '25.8809'
WHERE (fiat = 'DASH' OR currency = 'DASH');
UPDATE mercuryobusiness   
SET price = '0.614549'
WHERE (fiat = 'EOS' OR currency = 'EOS');
UPDATE mercuryobusiness   
SET price = '0.000482'
WHERE (fiat = 'RFOX' OR currency = 'RFOX');
UPDATE mercuryobusiness   
SET price = '0.37034'
WHERE (fiat = 'SAND' OR currency = 'SAND');
UPDATE mercuryobusiness   
SET price = '1'
WHERE (fiat = 'USDT' OR currency = 'USDT');
UPDATE mercuryobusiness   
SET price = '0.031979'
WHERE (fiat = 'VET' OR currency = 'VET');
UPDATE mercuryobusiness   
SET price = '34.3020'
WHERE (fiat = 'ZEC' OR currency = 'ZEC');

# 更新加密货币等价(U)
UPDATE mercuryobusiness   
SET coin_usd = ROUND( CAST( volume AS DECIMAL ( 20, 8 )) * CAST( price AS DECIMAL ( 20, 8 )), 5 )
WHERE (type = 'BUY' or type is NULL);
UPDATE mercuryobusiness   
SET coin_usd = ROUND( CAST( amout AS DECIMAL ( 20, 8 )) * CAST( price AS DECIMAL ( 20, 8 )), 5 )
WHERE type = 'SELL';

# 更新收益
UPDATE mercuryobusiness   
SET 
	profit = ROUND( CAST( volume AS DECIMAL ( 20, 8 )) * CAST('0.015' AS DECIMAL ( 20, 8 )), 5 )
WHERE
	status = 4 AND (type = 'BUY' or type is NULL);
UPDATE mercuryobusiness   
SET 
	profit = ROUND( CAST( amout AS DECIMAL ( 20, 8 )) * CAST('0.015' AS DECIMAL ( 20, 8 )), 5 )
WHERE
	status = 4  AND type = 'SELL';
UPDATE mercuryobusiness   
SET 
	fb = ROUND( CAST( profit AS DECIMAL ( 20, 8 )) * CAST(price AS DECIMAL ( 20, 8 )), 5 )
WHERE
	status = 4;
```
