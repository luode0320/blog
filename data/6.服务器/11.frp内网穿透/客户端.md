...
localIP = "127.0.0.1"
localPort = 22 #内网端口
remotePort = 10022 #公网服务器端口, 成功部署之后, 可以通过公网ip:端口访问内网的端口
...
type = "tcp"
localIP = "127.0.0.1"
localPort = 6379 #本地服务端口
remotePort = 16379 #远程服务器端口, 成功部署之后, 可以通过公网ip:7001访问内网的2000端口
...
localIP = "127.0.0.1"
localPort = 7400 #内网端口
remotePort = 17400 #公网服务器端口, 成功部署之后, 可以通过公网ip:端口访问内网的端口
```
