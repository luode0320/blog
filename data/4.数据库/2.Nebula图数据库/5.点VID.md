...
VID 的数据类型必须在[创建图空间](https://docs.nebula-graph.com.cn/3.8.0/3.ngql-guide/9.space-statements/1.create-space/)时定义，且一旦定义无法修改。

VID 必须在[插入点](https://docs.nebula-graph.com.cn/3.8.0/3.ngql-guide/12.vertex-statements/1.insert-vertex/)时设置，且一旦设置无法修改。
