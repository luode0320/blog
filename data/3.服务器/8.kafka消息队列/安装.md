...
docker run -d \
  ...
  -e KAFKA_CFG_LOG_RETENTION_MINUTES=10 \
  -e KAFKA_LOG_DIRS=/bitnami/kafka/data \
...
-e KAFKA_CFG_LOG_CLEANER_ENABLE=true # 开启日志清除
-e KAFKA_CFG_LOG_RETENTION_BYTES=1073741824 # 标记清除每个分区的日志大小，1GB=1073741824
-e KAFKA_CFG_LOG_SEGMENT_BYTES=104857600 # 标记清除每个分区每个分片日志的大小, 100M=104857600
-e KAFKA_CFG_LOG_RETENTION_MINUTES=10 # 每10分钟清除被标记的日志
```
